...
const PageHead = () => (
  <div style={{ padding: '14px 20px 0' }}>
    <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '.12em', textTransform: 'uppercase', color: 'rgba(40,57,108,.4)', marginBottom: 3 }}>Parent Dashboard</div>
    <div style={{ fontSize: 21, fontWeight: 700, color: '#1a2340', letterSpacing: '-.5px' }}>Concept Strengths</div>
    <div style={{ fontSize: 11, color: '#8892b0', marginTop: 2 }}>AI-powered learning tools for <strong style={{ color: '#28396c', fontWeight: 600 }}>Tanveer</strong></div>
  </div>
);
        ...
        <div style={{ margin: '14px 16px 0', background: '#fff', borderRadius: 18, padding: '14px 16px', boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06), 0 10px 28px rgba(40,57,108,.08)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: '#1a2340', letterSpacing: '-.2px' }}>Strong</span>
            </div>
            <span style={{ fontSize: 14, fontWeight: 700, color: '#1e9a5a', letterSpacing: '-.2px' }}>3</span>
          </div>
          {[
            { n: 'English', pct: 98 },
            { n: 'Unit 1', pct: 89 },
            ...
            <div key={i} style={{ marginBottom: i < arr.length - 1 ? 10 : 0 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: '#1e9a5a' }}>{r.pct}%</span>
              </div>
        ...
        <div style={{ margin: '10px 16px 0', background: '#fff', borderRadius: 18, padding: '14px 16px', boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: '#1a2340' }}>Developing</span>
            </div>
            <span style={{ fontSize: 14, fontWeight: 700, color: '#f59c2a' }}>1</span>
          </div>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
              <span style={{ fontSize: 12, fontWeight: 500, color: '#4a5578' }}>English Practical</span>
              <span style={{ fontSize: 12, fontWeight: 700, color: '#f59c2a' }}>75%</span>
            </div>
            <div style={{ height: 5, background: '#ede5d4', borderRadius: 3, overflow: 'hidden' }}>
        ...
        <div style={{ margin: '10px 16px 0', background: '#fff', borderRadius: 18, padding: '14px 16px', boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: '#1a2340' }}>Needs Work</span>
            </div>
            <span style={{ fontSize: 14, fontWeight: 700, color: '#e85555' }}>1</span>
          </div>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
              <span style={{ fontSize: 12, fontWeight: 500, color: '#4a5578' }}>Unit 1</span>
              <span style={{ fontSize: 12, fontWeight: 700, color: '#e85555' }}>65%</span>
            </div>
            <div style={{ height: 5, background: '#ede5d4', borderRadius: 3, overflow: 'hidden' }}>
          ...
          <div style={{ marginTop: 12, padding: '10px 12px', background: 'linear-gradient(135deg,#fffbee,#fff8e0)', borderRadius: 12, border: '.5px solid rgba(245,156,42,.2)', display: 'flex', alignItems: 'flex-start', gap: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, color: '#c07a10', marginBottom: 2 }}>Recommended Focus</div>
      ...
      <div className="sp-scroll">
        ...
        <div style={{ margin: '16px 16px 0', background: '#fff', borderRadius: 20, padding: 18, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06), 0 10px 28px rgba(40,57,108,.08)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a2340', letterSpacing: '-.3px', marginBottom: 3 }}>AI Study Plan Maker</div>
          ...
          <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '.09em', textTransform: 'uppercase', color: '#c0c8dc', marginBottom: 7 }}>Weak Topics Detected</div>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 14 }}>
            <div style={{ padding: '5px 11px', borderRadius: 100, fontSize: 11, fontWeight: 700, background: 'rgba(232,85,85,.09)', color: '#e85555', border: '.5px solid rgba(232,85,85,.18)' }}>unit 1</div>
            <div style={{ padding: '5px 11px', borderRadius: 100, fontSize: 11, fontWeight: 700, background: 'rgba(245,156,42,.1)', color: '#c07a10', border: '.5px solid rgba(245,156,42,.2)' }}>English Practical</div>
          </div>

          <div style={{ width: '100%', padding: 14, background: 'linear-gradient(135deg,#5b6fd4,#4a5cc8)', borderRadius: 14, fontSize: 14, fontWeight: 700, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, position: 'relative', overflow: 'hidden', boxShadow: '0 5px 20px rgba(91,111,212,.3)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {[
              ...
              <div key={s.title} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 10px', background: '#f5efe2', borderRadius: 12, border: '.5px solid rgba(40,57,108,.07)' }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#1a2340' }}>{s.title}</div>
                  <div style={{ fontSize: 10, color: '#8892b0', marginTop: 1 }}>{s.meta}</div>
                </div>
                <div style={{ fontSize: 10, fontWeight: 700, color: s.color, background: s.bg, padding: '3px 8px', borderRadius: 100, border: `.5px solid ${s.bdr}` }}>{s.prio}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="sp-scroll">
        ...
        <div style={{ margin: '16px 16px 0', background: '#fff', borderRadius: 20, padding: 18, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 16 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a2340', letterSpacing: '-.3px', marginBottom: 3 }}>24/7 Concept Explainer</div>
          ...
          <div style={{ marginTop: 10 }}>
            <div style={{ fontSize: 9, fontWeight: 700, letterSpacing: '.09em', textTransform: 'uppercase', color: '#c0c8dc', marginBottom: 7 }}>Quick Picks — Your Weak Topics</div>
        ...
        <div style={{ margin: '10px 16px 0', background: '#fff', borderRadius: 20, padding: 18, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a2340', letterSpacing: '-.3px', marginBottom: 3 }}>Practice Problem Generator</div>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <div style={{ padding: '12px 14px', background: 'linear-gradient(135deg,#f59c2a,#e88a15)', borderRadius: 12, fontSize: 12, fontWeight: 700, color: '#fff', display: 'flex', alignItems: 'center', gap: 5, flexShrink: 0, boxShadow: '0 4px 14px rgba(245,156,42,.28)' }}>
        ...
        <div style={{ margin: '10px 16px 0', background: '#fff', borderRadius: 20, padding: 18, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a2340', letterSpacing: '-.3px', marginBottom: 3 }}>AI Doubt Solver</div>
          ...
          <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
            <div style={{ flex: 1, padding: 11, background: '#f5efe2', borderRadius: 12, border: '.5px solid rgba(40,57,108,.07)', fontSize: 12, fontWeight: 700, color: '#4a5578', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
            ...
            <div style={{ flex: 1, padding: 11, background: 'linear-gradient(135deg,#e85599,#c03070)', borderRadius: 12, fontSize: 12, fontWeight: 700, color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, boxShadow: '0 4px 14px rgba(232,85,153,.28)' }}>
