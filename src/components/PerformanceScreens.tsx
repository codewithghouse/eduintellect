    ...
    <div className="sp">
      ...
      <div className="sp-scroll">
        ...
        <div style={{ padding: '18px 20px 0' }}>
          <div style={{ fontSize: 24, fontWeight: 300, color: '#1a2340', letterSpacing: '-.5px', display: 'flex', alignItems: 'center', gap: 8 }}>
            Performance Analytics
            <div style={{ width: 26, height: 26, borderRadius: 8, background: 'linear-gradient(140deg,#28396c,#334880)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 300, color: '#fff', boxShadow: '0 2px 8px rgba(40,57,108,.25)' }}>A</div>
          </div>
        ...
        <div style={{ margin: '14px 16px 0', background: '#fff', borderRadius: 22, padding: 18, boxShadow: '0 0 0 .5px rgba(40,57,108,.08), 0 4px 18px rgba(40,57,108,.09), 0 22px 52px rgba(40,57,108,.12)', border: '.5px solid rgba(40,57,108,.07)', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ fontSize: 16, fontWeight: 300, color: '#1a2340', letterSpacing: '-.2px' }}>Overall Performance</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8, marginTop: 14 }}>
            {[{ v: 'A', l: 'Grade', c: '#2ebc71' }, { v: '87%', l: 'Average', c: '#28396c' }, { v: '↑ +8%', l: 'Trend', c: '#2ebc71' }].map((s) => (
              <div key={s.l} style={{ background: '#f5efe2', borderRadius: 16, padding: '14px 10px', display: 'flex', flexDirection: 'column' as const, alignItems: 'center', gap: 5, border: '.5px solid rgba(40,57,108,.07)' }}>
                <div style={{ fontSize: s.l === 'Trend' ? 18 : 24, fontWeight: 300, letterSpacing: '-.6px', lineHeight: 1, color: s.c }}>{s.v}</div>
                <div style={{ fontSize: 9, fontWeight: 300, letterSpacing: '.08em', textTransform: 'uppercase' as const, color: '#c0c8dc' }}>{s.l}</div>
              </div>
            ))}
          </div>
          <div style={{ marginTop: 14, paddingTop: 14, borderTop: '.5px solid rgba(40,57,108,.07)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6, fontSize: 11, fontWeight: 400 }}><span style={{ color: '#8892b0' }}>Term Progress</span><span style={{ color: '#28396c' }}>87%</span></div>
        ...
        <div style={{ fontSize: 9, fontWeight: 300, letterSpacing: '.1em', textTransform: 'uppercase' as const, color: 'rgba(40,57,108,.35)', padding: '16px 20px 0', display: 'flex', alignItems: 'center', gap: 8 }}>Subject Performance<div style={{ flex: 1, height: '.5px', background: 'rgba(40,57,108,.13)' }} /></div>
        {/* Subjects */}
            ...
            <div key={s.name} style={{ padding: '14px 16px', borderBottom: i < subjects.length - 1 ? '.5px solid rgba(40,57,108,.07)' : 'none' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <div style={{ fontSize: 14, fontWeight: 400, color: '#1a2340', letterSpacing: '-.1px' }}>{s.name}</div>
                </div>
                <div style={{ padding: '4px 10px', borderRadius: 100, fontSize: 12, fontWeight: 300, background: s.gradeBg, color: s.color, border: `.5px solid ${s.gradeBdr}` }}>{s.grade}</div>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}><span style={{ fontSize: 10, fontWeight: 400, color: '#8892b0' }}>Progress</span><span style={{ fontSize: 12, fontWeight: 300, color: '#1a2340' }}>{s.pct}%</span></div>
              ...
              <div style={{ fontSize: 10, fontWeight: 400, color: s.color }}>{s.status}</div>
            </div>
          ))}
        </div>
        <div style={{ height: 20 }} />
  ...
  <div className="sp-wrap">
    ...
    <div className="sp">
      ...
      <div className="sp-scroll">
        <SPH />
        <div style={{ padding: '18px 20px 0' }}>
          <div style={{ fontSize: 24, fontWeight: 300, color: '#1a2340', letterSpacing: '-.5px' }}>Performance Trend</div>
        ...
        <div style={{ margin: '12px 16px 0', background: '#fff', borderRadius: 20, padding: 16, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06), 0 10px 28px rgba(40,57,108,.08)', border: '.5px solid rgba(40,57,108,.06)' }}>
          ...
          <div style={{ display: 'flex', gap: 14, marginTop: 10, flexWrap: 'wrap' as const }}>
            {[{ c: '#2ebc71', l: 'English' }, { c: '#2aacbc', l: 'Eng Practical' }, { c: '#28396c', l: 'Unit 1' }].map((lg) => (
              <div key={lg.l} style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 10, fontWeight: 400, color: '#4a5578' }}><div style={{ width: 7, height: 7, borderRadius: '50%', background: lg.c }} />{lg.l}</div>
            ))}
          </div>
        </div>
        {/* AI card */}
        <div style={{ margin: '12px 16px 0', background: 'linear-gradient(140deg,#28396c,#1e2d57)', borderRadius: 20, padding: 16, position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(40,57,108,.25)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 12, position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ fontSize: 8, fontWeight: 300, letterSpacing: '.12em', textTransform: 'uppercase' as const, color: 'rgba(255,255,255,.5)' }}>AI Narrative Analysis</div>
          </div>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,.88)', lineHeight: 1.7, position: 'relative', zIndex: 1 }}>Tanveer is performing best in English with <strong style={{ color: '#fff', fontWeight: 400 }}>98%</strong> this term — an excellent result. Overall performance is outstanding.</div>
          <div style={{ marginTop: 12, paddingTop: 12, borderTop: '.5px solid rgba(255,255,255,.08)', display: 'flex', alignItems: 'center', gap: 5, position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ fontSize: 9, fontWeight: 300, letterSpacing: '.08em', textTransform: 'uppercase' as const, color: 'rgba(255,255,255,.35)' }}>Generated from real-time data</div>
          </div>
        </div>
        <div style={{ height: 20 }} />
      </div>
    ...
    <div className="sp">
      ...
      <div className="sp-scroll">
        ...
        <div style={{ margin: '14px 16px 0', background: 'linear-gradient(140deg,#28396c,#1e2d57)', borderRadius: 20, padding: 16, position: 'relative', overflow: 'hidden', boxShadow: '0 8px 32px rgba(40,57,108,.25)' }}>
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,.88)', lineHeight: 1.7, position: 'relative', zIndex: 1 }}>Tanveer is performing best in English with <strong style={{ color: '#fff', fontWeight: 400 }}>98%</strong> — outstanding! Keep up the great work!</div>
        </div>
        {/* Goal setting */}
        <div style={{ margin: '12px 16px 0', background: '#fff', borderRadius: 20, padding: 16, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06), 0 10px 28px rgba(40,57,108,.08)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <div><div style={{ fontSize: 15, fontWeight: 300, color: '#1a2340', letterSpacing: '-.2px' }}>Goal Setting AI</div><div style={{ fontSize: 11, color: '#8892b0', marginTop: 2 }}>Set a target and get a personalised plan</div></div>
          </div>
          <div style={{ fontSize: 9, fontWeight: 300, letterSpacing: '.09em', textTransform: 'uppercase' as const, color: '#c0c8dc', marginBottom: 6 }}>Subject</div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}><span style={{ fontSize: 10, fontWeight: 300, letterSpacing: '.06em', textTransform: 'uppercase' as const, color: '#c0c8dc' }}>Target Score</span><span style={{ fontSize: 14, fontWeight: 300, color: '#f59c2a' }}>80%</span></div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 9, fontWeight: 400, color: '#c0c8dc', marginBottom: 12 }}><span>50%</span><span>75%</span><span>100%</span></div>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, padding: '12px 14px', background: 'rgba(46,188,113,.1)', borderRadius: 14, border: '.5px solid rgba(46,188,113,.2)' }}>
            ...
            <div><div style={{ fontSize: 13, fontWeight: 300, color: '#1e9a5a', letterSpacing: '-.1px' }}>Target already achieved in English!</div><div style={{ fontSize: 11, color: 'rgba(30,154,90,.7)', marginTop: 2 }}>Maintain consistency to stay at this level.</div></div>
          </div>
        </div>
        {/* Benchmark */}
        <div style={{ margin: '12px 16px 0', background: '#fff', borderRadius: 20, padding: 16, boxShadow: '0 0 0 .5px rgba(40,57,108,.06), 0 2px 8px rgba(40,57,108,.06), 0 10px 28px rgba(40,57,108,.08)', border: '.5px solid rgba(40,57,108,.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <div><div style={{ fontSize: 15, fontWeight: 300, color: '#1a2340', letterSpacing: '-.2px' }}>Benchmark Insights</div><div style={{ fontSize: 11, color: '#8892b0', marginTop: 2 }}>Where Tanveer stands vs benchmarks</div></div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            {[
              ...
              <div key={b.name} style={{ background: '#f5efe2', borderRadius: 16, padding: '14px 12px', border: '.5px solid rgba(40,57,108,.07)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}><span style={{ fontSize: 12, fontWeight: 400, color: '#1a2340' }}>{b.name}</span><span style={{ fontSize: 16 }}>{b.emoji}</span></div>
                <div style={{ display: 'inline-flex', padding: '4px 9px', borderRadius: 100, fontSize: 11, fontWeight: 300, background: b.rankBg, color: b.rankC, border: `.5px solid ${b.rankBdr}`, marginBottom: 5 }}>{b.rank}</div>
            ...
            <div style={{ gridColumn: 'span 2', background: '#f5efe2', borderRadius: 16, padding: '14px 12px', border: '.5px solid rgba(40,57,108,.07)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}><span style={{ fontSize: 12, fontWeight: 400, color: '#1a2340' }}>Unit 1</span><span style={{ fontSize: 16 }}>⭐</span></div>
              <div style={{ display: 'inline-flex', padding: '4px 9px', borderRadius: 100, fontSize: 11, fontWeight: 300, background: 'rgba(245,156,42,.1)', color: '#c07a10', border: '.5px solid rgba(245,156,42,.2)', marginBottom: 5 }}>Top 20%</div>
