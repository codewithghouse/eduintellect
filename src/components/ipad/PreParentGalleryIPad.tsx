...
const PreParentGalleryIPad = () => {
  ...
  return (
    <PrePrimaryParentIPadShell activePath="/gallery">
      <div style={{ background: '#FCF5FF', flex: 1, overflowY: 'auto', minHeight: 0, padding: '10px 12px 12px', fontFamily: "'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, sans-serif" }}>
        {/* Header */}
