    ...
    <div className="w-full max-w-6xl mx-auto px-4">
      <div className="text-center space-y-6 mb-16">
        ...
        <div className="relative inline-block">
          <h2 className="text-4xl md:text-5xl font-normal text-zinc-900 dark:text-white rotate-[-1deg]">
            {title}
        ...
        {tiers.map((tier, index) => (
          ...
          >
            ...
            <div className="relative p-6">
              {tier.popular && (
                <div className="absolute -top-2 -right-2 bg-amber-400 text-zinc-900 px-3 py-1 rounded-full rotate-12 text-sm border-2 border-zinc-900">
                  Popular!
                </div>
              )}
              ...
              <div className="mb-6 font-handwritten">
                <span className="text-4xl font-normal text-zinc-900 dark:text-white">
              ...
              <button
                className={cn(
                  'w-full h-12 text-lg relative rounded-md',
                  'border-2 border-zinc-900 dark:border-white',
                  'transition-all duration-300',
                  ...
                  tier.popular
                    ? 'bg-amber-400 text-zinc-900 hover:bg-amber-300 active:bg-amber-400 dark:hover:bg-amber-300 dark:active:bg-amber-400'
